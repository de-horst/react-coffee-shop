            ...
            <div className="footer__grid container grid">
                <div className="footer__content">
                    ...
                    <p className="footer__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, cumque possimus. Sapiente, exercitationem asperiores minima tempore rem ducimus quis aperiam hic alias, suscipit quas iste vel!
                    </p>
